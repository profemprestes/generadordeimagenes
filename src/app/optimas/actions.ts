...
export async function generateOptimalImagePromptAction(
  prevState: GenerateOptimalImagePromptState,
  formData: FormData
): Promise<GenerateOptimalImagePromptState> {
  const rawData = {
